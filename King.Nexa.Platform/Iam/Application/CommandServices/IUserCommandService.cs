...
public interface IUserCommandService
{
    ...
    Task<User?> UpdateProfileAsync(int id, string fullName, string phone, string preferredLanguage, bool criticalNotificationsEnabled, CancellationToken cancellationToken = default);
}
