...
namespace King.Nexa.Platform.Migrations
{
    ...
    [Migration("20260625021601_AddOperationalFoundationRecords")]
    partial class AddOperationalFoundationRecords
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("King.Nexa.Platform.Sales.Domain.Model.Aggregates.ClientAccount", b =>
                {
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("ix_client_accounts_code");

                    b.HasIndex("Ruc")
                        .HasDatabaseName("ix_client_accounts_ruc");
